      ...
      <div className="flex items-center justify-center p-4 flex-1">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl text-center">Cadastre-se gratuitamente</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {formData.password && (
                  <div className="flex items-center space-x-2 text-sm">
                    <Check className={`w-4 h-4 ${isPasswordValid ? 'text-green-500' : 'text-gray-400'}`} />
              ...
              <div className="space-y-2">
                ...
                {formData.confirmPassword && (
                  <div className="flex items-center space-x-2 text-sm">
                    <Check className={`w-4 h-4 ${isPasswordMatch ? 'text-green-500' : 'text-red-500'}`} />
